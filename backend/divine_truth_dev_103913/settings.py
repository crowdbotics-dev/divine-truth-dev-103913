"""
Django settings for divine_truth_dev_103913 project.
...
ROOT_URLCONF = 'divine_truth_dev_103913.urls'
...
WSGI_APPLICATION = 'divine_truth_dev_103913.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "divine_truth_dev_103913 API",
    "DESCRIPTION": "API documentation for divine_truth_dev_103913 App",
    "VERSION": "v1",
}
